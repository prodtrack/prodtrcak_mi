  ...
  return(
    <div>
      ...
      <div className="card" style={{padding:0,overflow:"hidden"}}>
        <div style={{display:"flex",alignItems:"center",gap:10,padding:"6px 10px",background:"#fafafa",borderBottom:"1px solid #f3f4f6",fontSize:10,color:"#9ca3af",...S,textTransform:"uppercase"}}>
        ...
        {materials.length===0
          ...
          :filtered.map((m,i)=>{
            ...
            return(
              <div key={m.id} style={{display:"flex",alignItems:"center",gap:10,padding:"6px 10px",borderBottom:i<filtered.length-1?"1px solid #f9fafb":undefined,borderLeft:zero?"3px solid #dc2626":"3px solid transparent",background:zero?"#fef2f2":"#fff",fontSize:12}}

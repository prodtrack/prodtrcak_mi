...
<style>
  ...
  *{box-sizing:border-box;-webkit-print-color-adjust:exact;print-color-adjust:exact;color-adjust:exact;}
  ...
  .remarks-row{border-top:1px solid #000;border-bottom:1px solid #000;padding:6px 8px;font-size:11px;min-height:36px;white-space:pre-line;break-inside:avoid;page-break-inside:avoid;}
